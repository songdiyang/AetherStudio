...
mod tests {
    ...
    fn test_capture_to_textmate_scope_variables() {
        assert_eq!(
            capture_to_textmate_scope("variable"),
            "variable.other.readwrite"
        );
        assert_eq!(
            capture_to_textmate_scope("variable.parameter"),
            "variable.parameter"
        );
        assert_eq!(
            capture_to_textmate_scope("variable.builtin"),
            "variable.language"
        );
        assert_eq!(
            capture_to_textmate_scope("variable.member"),
    ...
    fn test_capture_to_textmate_scope_constants() {
        ...
        assert_eq!(
            capture_to_textmate_scope("constant.builtin"),
            "constant.language"
        );
        assert_eq!(
            capture_to_textmate_scope("constant.macro"),
            "constant.other"
        );
    }
    ...
    fn test_capture_to_textmate_scope_modules_and_types() {
        ...
        assert_eq!(
            capture_to_textmate_scope("namespace"),
        ...
        assert_eq!(
            capture_to_textmate_scope("type.definition"),
    ...
    fn test_capture_to_textmate_scope_classes_and_structs() {
        ...
        assert_eq!(
            capture_to_textmate_scope("class.definition"),
            "entity.name.class.definition"
        );
        assert_eq!(
            capture_to_textmate_scope("interface"),
    ...
    fn test_capture_to_textmate_scope_functions() {
        assert_eq!(
            capture_to_textmate_scope("function"),
            "entity.name.function"
        );
        assert_eq!(
            capture_to_textmate_scope("function.builtin"),
            "support.function"
        );
        assert_eq!(
            capture_to_textmate_scope("function.macro"),
            "entity.name.function.macro"
        );
        assert_eq!(
            capture_to_textmate_scope("function.definition"),
            "entity.name.function.definition"
        );
        assert_eq!(
            capture_to_textmate_scope("method"),
            "entity.name.function.member"
        );
        assert_eq!(
            capture_to_textmate_scope("method.definition"),
            "entity.name.function.member.definition"
        );
        assert_eq!(
            capture_to_textmate_scope("constructor"),
            "entity.name.function.constructor"
        );
        assert_eq!(
            capture_to_textmate_scope("call"),
    ...
    fn test_capture_to_textmate_scope_properties() {
        assert_eq!(
            capture_to_textmate_scope("property"),
            "entity.name.property"
        );
        assert_eq!(
            capture_to_textmate_scope("property.definition"),
            "entity.name.property.definition"
        );
    ...
    fn test_capture_to_textmate_scope_keywords() {
        ...
        assert_eq!(
            capture_to_textmate_scope("keyword.conditional"),
            "keyword.control.conditional"
        );
        assert_eq!(
            capture_to_textmate_scope("keyword.repeat"),
            "keyword.control.repeat"
        );
        assert_eq!(
            capture_to_textmate_scope("keyword.return"),
            "keyword.control.return"
        );
        assert_eq!(
            capture_to_textmate_scope("keyword.import"),
            "keyword.control.import"
        );
        assert_eq!(
            capture_to_textmate_scope("keyword.exception"),
            "keyword.control.exception"
        );
        assert_eq!(
            capture_to_textmate_scope("keyword.operator"),
            "keyword.operator"
        );
        assert_eq!(
            capture_to_textmate_scope("keyword.directive"),
            "keyword.control.directive"
        );
        assert_eq!(
            capture_to_textmate_scope("keyword.function"),
            "keyword.declaration.function"
        );
        assert_eq!(
            capture_to_textmate_scope("keyword.type"),
            "keyword.declaration.type"
        );
        assert_eq!(capture_to_textmate_scope("keyword.storage"), "storage.type");
        assert_eq!(
            capture_to_textmate_scope("keyword.modifier"),
            "storage.modifier"
        );
    }
    ...
    fn test_capture_to_textmate_scope_operators() {
        ...
        assert_eq!(
            capture_to_textmate_scope("arithmetic"),
            "keyword.operator.arithmetic"
        );
        assert_eq!(
            capture_to_textmate_scope("logical"),
            "keyword.operator.logical"
        );
        assert_eq!(
            capture_to_textmate_scope("comparison"),
            "keyword.operator.comparison"
        );
        assert_eq!(
            capture_to_textmate_scope("assignment"),
    ...
    fn test_capture_to_textmate_scope_comments() {
        ...
        assert_eq!(
            capture_to_textmate_scope("comment.documentation"),
            "comment.block.documentation"
        );
        assert_eq!(
            capture_to_textmate_scope("doc"),
            "comment.block.documentation"
        );
    }
    ...
    fn test_capture_to_textmate_scope_strings() {
        ...
        assert_eq!(
            capture_to_textmate_scope("string.special"),
            "string.special"
        );
        assert_eq!(
            capture_to_textmate_scope("string.escape"),
            "constant.character.escape"
        );
        assert_eq!(capture_to_textmate_scope("string.regexp"), "string.regexp");
        assert_eq!(
            capture_to_textmate_scope("character"),
    ...
    fn test_capture_to_textmate_scope_numbers() {
        ...
        assert_eq!(
            capture_to_textmate_scope("integer"),
            "constant.numeric.integer"
        );
        assert_eq!(
            capture_to_textmate_scope("boolean"),
    ...
    fn test_capture_to_textmate_scope_tags_and_attributes() {
        ...
        assert_eq!(
            capture_to_textmate_scope("tag.builtin"),
            "entity.name.tag.builtin"
        );
        assert_eq!(
            capture_to_textmate_scope("tag.delimiter"),
            "punctuation.definition.tag"
        );
        assert_eq!(
            capture_to_textmate_scope("attribute"),
    ...
    fn test_capture_to_textmate_scope_punctuation() {
        ...
        assert_eq!(
            capture_to_textmate_scope("punctuation.delimiter"),
            "punctuation.separator"
        );
        assert_eq!(
            capture_to_textmate_scope("punctuation.bracket"),
            "punctuation.section"
        );
        assert_eq!(
            capture_to_textmate_scope("punctuation.special"),
    ...
    fn test_capture_to_textmate_scope_misc() {
        ...
        assert_eq!(
            capture_to_textmate_scope("lifetime"),
            "storage.modifier.lifetime"
        );
        assert_eq!(
            capture_to_textmate_scope("macro"),
            "entity.name.function.macro"
        );
        assert_eq!(
            capture_to_textmate_scope("include"),
            "keyword.control.import"
        );
        assert_eq!(
            capture_to_textmate_scope("exception"),
            "keyword.control.exception"
        );
    }
    ...
    fn test_build_theme_mapping() {
        ...
        assert_eq!(
            map.get("variable"),
            Some(&"variable.other.readwrite".to_string())
        );
        ...
        assert_eq!(
            map.get("function"),
            Some(&"entity.name.function".to_string())
        );
